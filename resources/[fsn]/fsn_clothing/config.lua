...
ems_models = {'csb_mweather','csb_prolsec','csb_ramp_marine','cs_casey','cs_fbisuit_01','s_f_y_ranger_01','s_f_y_scrubs_01','s_m_m_armoured_01','s_m_m_armoured_02','s_m_m_chemsec_01','s_m_m_fiboffice_01','s_m_m_marine_01','s_m_m_marine_02','s_m_m_paramedic_01','s_m_m_prisguard_01','s_m_m_security_01','s_m_y_doorman_01','s_m_y_fireman_01','s_m_y_marine_01','s_m_y_marine_02','s_m_y_marine_03'}
...
local clothing_shops = {
    ...
    {name="MRPD", id=60, x =456.7221, y =-990.9374, z =30.6896}, --Mission Row PD
    ...
    {name="", id=NULL, x=-452.683, y=6013.973, z=31.716}, --Paleto Bay Station
}
incircle = false
