...
return {
	...
	CHandlingData {
		...
		-- Physical
		Mass               = 930,
		InitialDragCoeff   = 7.61,
		PercentSubmerged   = 102,
		CentreOfMassOffset = { 0,    -0.12, -0.092 },
		InertiaMultiplier  = { 0.94, 0.92,    1.4 },
