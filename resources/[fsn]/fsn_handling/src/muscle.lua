...
return {
	...
	CHandlingData {
		...
		HandlingName = "NIGHTSHADE", -- Missing handling
		-- Physical
		Mass               = 1650,
		InitialDragCoeff   = 5.36,
		DownforceModifier  = 1.41,
