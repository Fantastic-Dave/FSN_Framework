	...
	height = 0.04,
		...
		["sports"] = {
			...
			buttons = {
				...
				{name = "Elegy Sport", costs = 170000, description = {}, model = "elegy"},
		...
		["super"] = {
			...
			name = "super",
			buttons = {
				{name = "Adder", costs = 6100000, description = {}, model = "adder"},
				{name = "Banshee 900R", costs = 3565000, description = {}, model = "banshee2"},
				{name = "Bullet", costs = 400000, description = {}, model = "bullet"},
				{name = "Cheetah", costs = 4500000, description = {}, model = "cheetah"},
				{name = "Entity XF", costs = 4595000, description = {}, model = "entityxf"},
				{name = "Sheava", costs = 3199500, description = {}, model = "sheava"},
				{name = "Banshee", costs = 3200000, description = {}, model = "banshee"},
				{name = "FMJ", costs = 5350000, description = {}, model = "fmj"},
				{name = "Infernus", costs = 3440000, description = {}, model = "infernus"},
				{name = "Osiris", costs = 4950000, description = {}, model = "osiris"},
				{name = "Reaper", costs = 3595000, description = {}, model = "reaper"},
				{name = "Sultan RS", costs = 1795000, description = {}, model = "sultanrs"},
				{name = "Super D", costs = 5250000, description = {}, model = "superd"},
				{name = "T20", costs = 6500000, description = {}, model = "t20"},
				{name = "Turismo R", costs = 6500000, description = {}, model = "turismor"},
				{name = "Tyrus", costs = 8550000, description = {}, model = "tyrus"},
				{name = "Vacca", costs = 6240000, description = {}, model = "vacca"},
				{name = "Voltic", costs = 1150000, description = {}, model = "voltic"},
				{name = "X80 Proto", costs = 4700000, description = {}, model = "prototipo"},
				{name = "Zentorno", costs = 8725000, description = {}, model = "zentorno"},
			}
		},
		["muscle"] = {
			title = "muscle",
		...
		["motorcycles"] = {
			...
			buttons = {
				...
				{name = "Bati 801RR", costs = 25000, description = {}, model = "bati2"},
				...
				{name = "Sanchez", costs = 5000, description = {}, model = "sanchez"},
