	...
	height = 0.04,
		...
		["coupes"] = {
			...
			buttons = {
				...
				{name = "Exemplar", costs = 150000, description = {}, model = "exemplar"},
				...
				{name = "Sentinel XS", costs = 120000, description = {}, model = "sentinel2"},
				{name = "Windsor", costs = 145000, description = {}, model = "windsor"},
				{name = "Windsor Convertible", costs = 165000, description = {}, model = "windsor2"},
				{name = "Zion", costs = 80000, description = {}, model = "zion"},
				{name = "Zion 2 ST", costs = 95000, description = {}, model = "zion2"},
		...
		["sports"] = {
			...
			name = "sports",
			buttons = {
				{name = "Alpha", costs = 40009, description = {}, model = "alpha"},
				{name = "Bestia GTS", costs = 165000, description = {}, model = "bestiagts"},
				{name = "Buffalo", costs = 55000, description = {}, model = "buffalo"},
				{name = "Buffalo S", costs = 80000, description = {}, model = "buffalo2"},
				...
				{name = "NineF Convertible", costs = 160000, description = {}, model = "ninef2"},
				{name = "Omnis", costs = 145000, description = {}, model = "omnis"},
				{name = "Penumbra", costs = 50000, description = {}, model = "penumbra"},
				{name = "Rapid GT", costs = 165000, description = {}, model = "rapidgt"},
		...
		["sportsclassics"] = {
			...
			buttons = {
				...
				{name = "RapidGT Retro", costs = 130000, description = {}, model = "rapidgt3"},
		...
		["muscle"] = {
			...
			buttons = {
				...
				{name = "Gauntlet 2", costs = 135000, description = {}, model = "gauntlet2"},
		...
		["offroad"] = {
			...
			buttons = {
				...
				{name = "Bubsta 6x6", costs = 105000, description = {}, model = "dubsta3"},
				{name = "Dune Buggy (R)", costs = 25000, description = {}, model = "dune"},
				{name = "Beach Bum Caddy", costs = 20000, description = {}, model = "Kalahari"},
		...
		["suvs"] = {
			...
			buttons = {
				...
				{name = "Patriot", costs = 24000, description = {}, model = "patriot"},
				{name = "Patriot Stretch", costs = 70000, description = {}, model = "patriot2"},
		...
		["motorcycles"] = {
			...
			buttons = {
				...
				{name = "Bati 801RR", costs = 55000, description = {}, model = "bati2"},
				...
				{name = "Enduro", costs = 5000, description = {}, model = "enduro"},
				...
				{name = "Innovation", costs = 34000, description = {}, model = "innovation"},
				...
				{name = "Ruffian", costs = 27000, description = {}, model = "ruffian"},
