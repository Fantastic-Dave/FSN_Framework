	...
	height = 0.04,
		...
		["coupes"] = {
			...
			buttons = {
				...
				{name = "Bentley Continental", costs = 250000, description = {}, model = "windsor"},
				{name = "Bentley Continental 2", costs = 850000, description = {}, model = "windsor2"},
		...
		["sports"] = {
			...
			name = "sports",
			buttons = {
				{name = "Mistubishi Eclipse", costs = 95000, description = {}, model = "ninef2"},
				...
				{name = "Toyota Supra", costs = 95000, description = {}, model = "feltzer2"},
				...
				{name = "Mitsi Evo", costs = 75000, description = {}, model = "kuruma"},
				{name = "Lynx", costs = 175000, description = {}, model = "lynx"},
				{name = "Toyota Supra Sport", costs = 225000, description = {}, model = "massacro"},
				{name = "Toyota Supra Sport GT", costs = 150000, description = {}, model = "massacro2"},
		...
		["sedans"] = {
			...
			buttons = {
				...
				{name = "BMW 750Li", costs = 50000, description = {}, model = "stratum"},
				{name = "Stretch", costs = 65000, description = {}, model = "stretch"},
				{name = "Mercedes 500 SEL", costs = 250000, description = {}, model = "superd"},
				{name = "Surge", costs = 38000, description = {}, model = "surge"},
				{name = "Mercedss Maybach", costs = 275000, description = {}, model = "tailgater"},
				{name = "Warrener", costs = 120000, description = {}, model = "warrener"},
				{name = "BWM 750i", costs = 15000, description = {}, model = "washington"},
			}
		},
		["motorcycles"] = {
			title = "MOTORCYCLES",
