	...
	height = 0.04,
		...
		["compacts"] = {
			...
			buttons = {
				...
				{name = "Brioso R/A", costs = 150000, description = {}, model = "brioso"},
				{name = "Dilettante", costs = 30000, description = {}, model = "Dilettante"},
				{name = "Issi 2 Convertible", costs = 52000, description = {}, model = "issi2"},
				{name = "Panto", costs = 25000, description = {}, model = "panto"},
				{name = "Prairie", costs = 60000, description = {}, model = "prairie"},
		...
		["coupes"] = {
			...
			buttons = {
				...
				{name = "Zion 2 ST", costs = 12d0000, description = {}, model = "zion2"},
		...
		["sports"] = {
			...
			buttons = {
				...
				{name = "Comet 2", costs = 175000, description = {}, model = "comet2"},
				{name = "Comet 3", costs = 200000, description = {}, model = "comet3"},
				...
				{name = "Massacro", costs = 575000, description = {}, model = "massacro"},
				...
				{name = "Sultan", costs = 200000, description = {}, model = "sultan"},
		...
		["super"] = {
			...
			buttons = {
				...
				{name = "Bullet", costs = 3500000, description = {}, model = "bullet"},
				{name = "Cheetah", costs = 5000000, description = {}, model = "cheetah"},
				{name = "Entity XF", costs = 5950000, description = {}, model = "entityxf"},
				{name = "Sheava", costs = 1995000, description = {}, model = "sheava"},
				{name = "Banshee", costs = 2000000, description = {}, model = "banshee"},
				{name = "FMJ", costs = 6350000, description = {}, model = "fmj"},
				{name = "Infernus", costs = 4400000, description = {}, model = "infernus"},
				{name = "Osiris", costs = 5950000, description = {}, model = "osiris"},
				{name = "Reaper", costs = 8595000, description = {}, model = "reaper"},
				...
				{name = "Vacca", costs = 2400000, description = {}, model = "vacca"},
				{name = "Voltic", costs = 1500000, description = {}, model = "voltic"},
				{name = "X80 Proto", costs = 2000000, description = {}, model = "prototipo"},
		...
		["muscle"] = {
			...
			buttons = {
				...
				{name = "Dominator GTX", costs = 125000, description = {}, model = "dominator3"},
