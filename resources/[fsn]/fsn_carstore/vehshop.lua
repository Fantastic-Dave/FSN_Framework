	...
	height = 0.04,
		...
		["motorcycles"] = {
			...
			buttons = {
				...
				{name = "Lectro", costs = 25000, description = {}, model = "lectro"},
				{name = "Nemesis", costs = 90000, description = {}, model = "nemesis"},
				{name = "PCJ-600", costs = 45999, description = {}, model = "pcj"},
				...
				{name = "Vader", costs = 26000, description = {}, model = "vader"},
